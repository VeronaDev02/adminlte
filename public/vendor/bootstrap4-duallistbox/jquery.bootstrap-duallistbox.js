  ...
  BootstrapDualListbox.prototype = {
    ...
    setBootstrap2Compatible: function(value, refresh) {
      ...
      if (value) {
        ...
        this.container.find('.moveall > i, .move > i').removeClass('fas fa-arrow-alt-circle-right').addClass('fas fa-arrow-alt-circle-right');
        this.container.find('.removeall > i, .remove > i').removeClass('fas fa-arrow-alt-circle-left').addClass('fas fa-arrow-alt-circle-left');
      } else {
